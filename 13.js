...
(function ($) {
    ...
    <style id="national-day-offers-style">
      ...
      /* ===== تمييز عروض الادمن والخواص المميزة ===== */
      #national-day-offers .ndo-row.gold-admin-offer{
        background:linear-gradient(180deg,#fff9dc 0%,#fff0a8 100%) !important;
        border:1px solid #d4af37 !important;
        border-right:4px solid #d4af37 !important;
        border-radius:8px !important;
        box-shadow:0 2px 8px rgba(212,175,55,.22) !important;
        margin:4px 0 !important;
      }

      #national-day-offers .ndo-row.black-admin-offer{
        background:linear-gradient(180deg,#f2f2f2 0%,#dddddd 100%) !important;
      ...
      #national-day-offers .ndo-row.first-five-offer{
        background:linear-gradient(180deg,#f4efff 0%,#e8ddff 100%) !important;
        border:1px solid #7a52c7 !important;
        border-right:4px solid #6a3fc1 !important;
        border-radius:8px !important;
        box-shadow:0 2px 8px rgba(106,63,193,.18) !important;
        margin:5px 0 !important;
      }

      #national-day-offers .ndo-row.first-five-offer .first-five-badge{
        color:#fff !important;
        background:#6a3fc1 !important;
    ...
    <div id="national-day-offers">
      ...
      <div class="ndo-body">
        ...
        <div class="ndo-row gold-admin-offer">
        ...
        <div class="ndo-row black-admin-offer">
          ${img(ICONS.blackShield, "", "درع اسود")}
        ...
        <div class="ndo-row first-five-offer">
          <span>💎</span>
          <span class="blue first-five-badge">لـ اول 5 اشخاص</span>
