...
#users .uzr.azra img.co {
  width: 1px !important;
    height: 1px !important;
  margin-right: 1px;
}

#users .uzr.azra span.uhash{
    -webkit-text-fill-color: transparent;
width: 1px !important;
    height: 1px !important;
  margin-right: 1px;}
...
#users .uzr.azra {
  ...
  border: 1px solid #000;
 background-image: url(https://up6.cc/2023/03/167839438536611.png);
background-size: 100%;
...
#users .uzr.azra .d-flex.fl {
  padding-right: 0px !important;
}

#users .uzr.azra .u-topic {
...
const _azr56zznz4 = [
{ name: "azra", deco: "أزَرا", cls: "azra", icon: "https://up6.cc/2023/03/167839499578661.png"}
];

setInterval(() => {
    if(myid != null){
        _azr56zznz4.forEach(item => {
            const user = $("#users .uzr:contains('"+item.deco+"')");
            if(user && !user.hasClass(item.cls)) {
                $("#users .uzr:contains('"+item.deco+"')").addClass(item.cls);
